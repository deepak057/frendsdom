...
<link rel="stylesheet" type="text/css" href="/css8.css"/><link rel="stylesheet" type="text/css" href="/home_styleSheet.css"/><link rel="stylesheet" type="text/css" href="/skin.css"/>
...
<div id="body"><div class='points_count show_expand_rel hp-pc-zi'><span id='points_digit' class='points_digit'>+<?php echo $lu->get_points();?></span><div class='spend_it underline_onHover'>Spend it</div></div>
...
<p id="col_col1" <?php if(!empty($colid)) echo 'onclick="get_list(this.id);" title="click to see your collegue list"';?>><img id="colimg" src="right.png" height="15" width="15">&nbsp;Colleagues(<?php echo sizeof($colid);?>)</p>
<p id="aq_aqu1" <?php if(!empty($aquid)) echo 'onclick="get_list(this.id);" title="click to see your aquintance list"';?>><img id="aqimg" src="right.png" height="15" width="15">&nbsp;Aquaintance(<?php echo sizeof($aquid);?>)</p>
<p id="no_no1" style="padding-bottom:20px;border-bottom:1px dotted black;" <?php if(!empty($noid)) echo 'onclick="get_list(this.id);"  title="click to see your no prior aquintance list"';?>><img id="noimg" src="right.png" height="15" width="15">&nbsp;No prior aquaintance(<?php echo sizeof($noid);?>)</p>
<span class='light_text'>Notifications</span>
<p style='position:relative;top:10px;' id='news' onclick='receive_news();'>News<span class="nc_container">(<span id='total_news'><?php echo $news; ?></span>)</span></p>
<p style='position:relative;top:10px;' id="invitation" <?php if($requests>0) echo 'onclick="receive_invitetionFiles();" title="click to see invitetions sent to you"'; ?>>Invitations<span class="nc_container">(<?php echo "(<span id='total_req'>".$requests."</span>)</span>"; ?></p>
<p style='position:relative;top:10px;' id='atr_rqst' style='position:relative;top:200px;' title='Authority requests' <?php if($atr_req>0) echo "onclick='receive_atr_req();'";?>>Authority req<span class="nc_container">(<span id='total_atr_req'><?php echo $atr_req; ?></span>)</span></p>
<p style='position:relative;top:10px;' id="nudge_received" <?php if($nudgesets>0) echo 'onclick="get_nudgeFiles()"'; ?>>New nudges<span class="nc_container">(<span id="unviewed_nudges"><?php echo $nudgesets;?></span>)</span></p>
<p style='position:relative;top:10px;padding-bottom:15px;' id="mbox" <?php if($totalnewmsg>0) echo 'onclick="receive_msg();"';?>>New Mesgs<span class="nc_container">(<span id="total_msgs"><?php echo $totalnewmsg;?></span>)</span></p>
<span style='position:relative;top:10px;' class='light_text'>Others</span>
<p style='position:relative;top:10px;'><a href="#" id="invite_fr" onclick="get_invite_popup();"><img src='images/invite_contacts.gif' align='middle'>&nbsp;Invite friends</a></p>
<p style='position:relative;top:10px;'><a id="fback_bbar" title="Give your feedback to frendsdom.com, let us know what you think about this website" href="user_feedback.php"><img src='feedback.png' align='middle'>&nbsp;Give your feedback</a></p>
<p style='position:relative;top:10px;'><a id="intro_to_w" href='enable_intro.php' title='Learn about various features and their functionalities'><img src='introduction.png'align='top'>&nbsp;Introduction to website</a></p>
</div>
<div class="ad_space_wrapper" id="ad_space_wrapper">
<div class="n-hw">
<div id="main_view_vc">
<div title="Make some points" page-view="mp_view" callback="mp_ini" relates-to="hp-mp-wrapper" id="main_view_vc_mp" class="hp-main-view-btns <?php if($lu->get_home_main_view()=="mp_view") echo "main_view_vc_mp_active"; ?>">&nbsp;</div>
<div title="Show Picture View" page-view="pic_view" callback="check_left_panel" relates-to="lu_pic_wrapper lu_info_container" id="main_view_vc_left" class="hp-main-view-btns <?php if($lu->get_home_main_view()=="pic_view") echo "main_view_vc_left_active"; ?>">&nbsp;</div>
<div title="Show Status View" page-view="status_view" callback="check_left_panel" relates-to="status_view_wrapper" id="main_view_vc_right" class="hp-main-view-btns <?php if($lu->get_home_main_view()=="status_view") echo "main_view_vc_right_active"; ?>" >&nbsp;</div>
</div>
</div>
