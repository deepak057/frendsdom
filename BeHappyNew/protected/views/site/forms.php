...
<button type="submit" class="btn" id="signup-page-submit">Sign In</button>
<div class="social_buttons_row">
</div>
</form>

<button onclick="window.location='<?php echo $login_url; ?>';" onlogin="checkLoginState();" type="submit" id="login-submit-fb" class="btn btn-primary btn-block facebook_login_button"><i class="fa fa-facebook" aria-hidden="true"></i>Facebook</button>
