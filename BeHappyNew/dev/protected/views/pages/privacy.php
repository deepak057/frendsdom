<p>Our Privacy Policy was last updated and posted on 7 January 2016. It governs the privacy terms of our Website, located at <a href="<?php echo Helpers::base_url(); ?>"><?php echo Helpers::base_url(); ?></a>. Any capitalized terms not defined in our Privacy Policy, have the meaning as specified in our Terms of Service.</p>
<p>Your privacy is very important to us. Accordingly, we have developed this Policy in order for you to understand how we collect, use, communicate and disclose and make use of personal information. We use your Personal Information only for providing and improving the Site. By using the Site, you agree to the collection and use of information in accordance with this policy. Unless otherwise defined in this Privacy Policy, terms used in this Privacy Policy have the same meanings as in our Terms and Conditions, accessible at <a href="<?php echo Helpers::base_url(); ?>"> <?php echo Helpers::base_url(); ?></a>. The following outlines our privacy policy.</p>
<ul>
...
<p>Under the Child's Online Privacy Security Act, no web site operator can require, as a condition to involvement in an activity, that a child younger than 13 years of age divulge more details than is reasonably required. <?php echo Yii::app()->name; ?> abides by this demand. <?php echo Yii::app()->name; ?> just collects information willingly offered; no information is gathered passively. children under 13 can submit only their email address when sending us an email in our &quot;Contact Us&quot; area. <?php echo Yii::app()->name; ?> makes use of the e-mail address to respond to a one-time demand from a child under 13 and afterwards deletes the e-mail address. In case <?php echo Yii::app()->name; ?> collects and maintains personal information relating to a child under 13, the parent may send out an email to us  to review, alter and/or erase such info as well as to decline to enable any additional collection or use of the child's information.</p>
