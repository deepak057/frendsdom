...
//Save notification for owner of the post
//Save comment notification for owner of the post
$notiController = helpers::get_controller(NOTIFICATION);

$notiController->SaveNotification($post_id,"vote","",array(helpers::GetOwner($post_id)),$model->id);
...
$notiController->DeleteNotification($post_id,"vote",helpers::uid());
