...
$callback='http://frendsdom.com/oauth/yahoo/getacctok.php';
...
//storing required values in session variables
parse_str($body);
$_SESSION['yahoo_oauth_token']=$oauth_token;
