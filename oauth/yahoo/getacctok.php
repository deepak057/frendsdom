...
$request_token=$_SESSION['yahoo_oauth_token'];
$request_token_secret=$_SESSION['yahoo_oauth_token_secret'];
...
parse_str($body);
$_SESSION['yahoo_access_token']=$oauth_token;
$_SESSION['yahoo_oauth_token_secret']=$oauth_token_secret;
$_SESSION['yahoo_xoauth_yahoo_guid']=$xoauth_yahoo_guid;


//redirecting to final page
header('location:callcontact.php');
