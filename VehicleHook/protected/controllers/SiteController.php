...

{
	...
	/** Flag to turn on "minimal layout"
	** If set true, the layout will have some major sections disabled, this sections may include Header, Footer and only the 
	** Content part will be visible 
	**/
	...
	**/
	...
	public function accessRules()
	{
		return array(
			array('allow', 
				'actions'=>array('login','signup','index','resetpassword','error','test','demo'),
				'users'=>array('*'),
			),
			array('allow',
	...
	**/
	...
	$this->minimal_layout=true;

	$this->render("demo",array("random_posts"=>Helpers::get_controller(POSTS)->GetRandomPosts($GLOBALS['app_config']['default_count']['demo_posts'])));	
