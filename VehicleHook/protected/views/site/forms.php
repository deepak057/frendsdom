...
<div class="fg-line">
<input required value="<?php echo $email?$email:""; ?>" class="form-control" placeholder="Email Address" type="email" id="signup-page-email"></div></div>
...
<button type="submit" class="btn btn-login btn-danger btn-float waves-effect waves-button waves-float" id="signup-page-submit">
<i class="md md-arrow-forward"></i></button>
</form>
<ul class="login-navigation">
