...
(function(){
    ...
    if (layoutStatus == 1 && typeof Globals!= "undefined" && Globals.IsLoggedIn()) {
    ...
    $('body').on('change', '#toggle-width input:checkbox', function(){
        if ($(this).is(':checked')) {
            setTimeout(function(){
                ...
                if (typeof SetPostsGrid != "undefined") {
                    SetPostsGrid.Init();
                }

                if(typeof CirclesSlider!="undefined"){
...
/*
    ...
    */
	...
	$(document).on("mouseover",'.date-picker',function(e){
