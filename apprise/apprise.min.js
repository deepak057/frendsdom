...
{var default_args={'confirm':false,'verify':false,'input':false,'animate':false,'textOk':'Ok','textCancel':'Cancel','textYes':'Yes','textNo':'No','takeControl':false,'type':'text'}
if(args)
...
{$('.appriseInner').append('<div class="aInput"><input type="'+args['type']+'" class="aTextbox" t="aTextbox" value="'+args['input']+'" /></div>');}
else
{$('.appriseInner').append('<div class="aInput"><input type="'+args['type']+'" class="aTextbox" t="aTextbox" /></div>');}
$('.aTextbox').focus();}}
...
{$('.aButtons').append('<button id="apprise_ok_btn" value="ok">Ok</button>');}
...
function hide_apprise()
{
$('.appriseOverlay').hide();
$('.appriseOuter').hide();
}

function show_apprise()
{
$('.appriseOverlay').show();
$('.appriseOuter').show();
}
...
function remove_apprise()
{
$('.appriseOverlay').remove();
$('.appriseOuter').remove();
}

$("#apprise_ok_btn").live("click",function(){
remove_apprise();
});