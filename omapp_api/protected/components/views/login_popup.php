								...
								<span class="mark-it">or</span></div>-->
                                 ...
                                 <div class="form-group">
								 		...
								 		<div class="form-group social_buttons">
											  <button onclick="event.preventDefault();fb_login();" onlogin="checkLoginState();" type="submit" id="login-submit-fb" class="btn btn-primary btn-block facebook_login_button"><i class="fa fa-facebook" aria-hidden="true"></i>
 											  Facebook</button>
