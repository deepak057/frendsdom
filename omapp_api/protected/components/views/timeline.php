                                ...
                                <div class="t-view" data-tv-type="text">
                                    <div class="tv-header media">
                                        <a href="" class="tvh-user pull-left">
                                            <img class="img-responsive" src="<?php echo $theme_url;?>/img/profile-pic-2.jpg" alt="">
                                        </a>
...
consectetur adipiscing elit. Duis sem dolor, posuere convallis blandit 
sit amet, aliquet in est. Ut condimentum magna enim, non venenatis elit 
interdum accumsan. In hac habitasse platea dictumst. Etiam molestie 
felis non mollis viverra. In ipsum lorem, fermentum vitae lectus in, 
accumsan malesuada neque.</p>
                                    
                                        <p>Suspendisse vehicula urna 
nisi, in luctus lacus consequat at. Nam purus dolor, tristique id 
lacinia sed, tincidunt congue metus. Lorem ipsum dolor sit amet, 
consectetur adipiscing elit. Vivamus nec gravida leo. Sed nec ligula 
porta, dignissim elit molestie, finibus ligula. Nunc venenatis malesuada
 est ac molestie. Phasellus ornare nibh eu nisl rhoncus, vitae porttitor
 ante feugiat. Nulla vehicula erat nec odio dignissim, sit amet 
porttitor lorem auctor. Maecenas fermentum tellus ex, ac aliquet nisl 
malesuada id.</p>
                                    ...
                                    <div class="tv-comments">
                                        <ul class="tvc-lists">
                                            <li class="media">
                                                <a href="" class="tvh-user pull-left">
                                                    <img class="img-responsive" src="<?php echo $theme_url;?>/img/1_002.jpg" alt="">
                                                </a>
...
Maecenas fermentum tellus ex, ac aliquet nisl malesuada id.</div>
                                            ...
                                            <li class="media">
                                                <a href="" class="tvh-user pull-left">
                                                    <img class="img-responsive" src="<?php echo $theme_url;?>/img/3_002.jpg" alt="">
                                                </a>
                                                <div class="media-body">
                                            ...
                                            <li class="p-20">
                                                <div class="fg-line">
                                                    <textarea style="overflow: hidden; word-wrap: break-word; height: 36px;" class="form-control auto-size" placeholder="Write a comment..."></textarea>
                                                </div>
                                                
                                                <button class="m-t-15 btn btn-primary btn-sm waves-effect waves-button waves-float waves-effect waves-button waves-float">Post</button>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
                                        ...
                                        <div class="lightbox m-b-20">
                                            <div data-src="img/headers/sm/4.png">
                                                <div class="lightbox-item pull-left">
                                                    <img src="<?php echo $theme_url;?>/img/4.png" alt="">
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <ul class="tvc-lists">
                                            <li class="media">
                                                ...
                                                <div class="media-body">
                                                    ...
                                                    <div class="m-t-10">Donec
 vel metus nisl. Nam euismod neque et finibus vulputate. Integer in 
vestibulum orci. Phasellus ut iaculis arcu, vitae commodo justo. Ut eu 
feugiat lorem, quis ornare risus</div>
                                ...
                                <div class="t-view" data-tv-type="video">
                                    ...
                                    <div class="tv-body">
                                        ...
                                        <div class="embed-responsive embed-responsive-16by9 m-b-20">
                                            <iframe class="embed-responsive-item" src="<?php echo $theme_url;?>/img/aaZXDm3RXuo.html"></iframe>
                                        </div>
                                        
                                        <p>Duis sem dolor, posuere 
convallis blandit sit amet, aliquet in est. Ut condimentum magna enim, 
non venenatis elit interdum accumsan. In hac habitasse platea dictumst. 
Etiam molestie felis non mollis viverra. In ipsum lorem, fermentum vitae
 lectus in, accumsan malesuada neque.</p>
                                    ...
                                    <div class="tv-comments">
                                        <ul class="tvc-lists">
                                            <li class="media">
                                                <a href="" class="tvh-user pull-left">
                                                    <img class="img-responsive" src="<?php echo $theme_url;?>/img/6.jpg" alt="">
                                                </a>
                                                <div class="media-body">
                                                    <strong class="d-block">Jolla Hatkin</strong>
                                                    <small class="c-gray">April 23, 2014 at 05.00</small>
...
feugiat lorem, quis ornare risus</div>
                                            ...
                                            <li class="media">
                                                <a href="" class="tvh-user pull-left">
                                                    <img class="img-responsive" src="<?php echo $theme_url;?>/img/5.jpg" alt="">
                                                </a>
                                                <div class="media-body">
                                        ...
                                        <div class="lightbox tvb-lightbox clearfix">
                                            <div data-src="media/gallery/1.jpg" class="col-sm-2 col-xs-3">
                                                <div class="lightbox-item">
                                                    <img src="<?php echo $theme_url;?>/img/1.jpg" alt="">
                                                </div>
                                            </div>
            
                                            <div data-src="media/gallery/2.jpg" class="col-sm-2 col-xs-3">
                                                <div class="lightbox-item">
                                                    <img src="<?php echo $theme_url;?>/img/2.jpg" alt="">
                                                </div>
                                            </div>
                                       
                                            <div data-src="media/gallery/3.jpg" class="col-sm-2 col-xs-3">
                                                <div class="lightbox-item">
                                                    <img src="<?php echo $theme_url;?>/img/3.jpg" alt="">
                                                </div>
                                            </div>
                                        
                                            <div data-src="media/gallery/4.jpg" class="col-sm-2 col-xs-3">
                                                <div class="lightbox-item">
                                                    <img src="<?php echo $theme_url;?>/img/4.jpg" alt="">
                                                </div>
                                            </div>
                                        </div>
                                        
                                        <p>Ut condimentum magna enim, 
non venenatis elit interdum accumsan. In hac habitasse platea dictumst. 
Etiam molestie felis non mollis viverra. In ipsum lorem, fermentum vitae
 lectus in, accumsan malesuada neque.</p>
